    ...
    if legend is None:
        ...
        for json_log in args.json_logs:
            ...
            for metric in args.keys:
                ...
                if metric=='loss_odm_srcls':legend.append('{}'.format("loss_perceptual"))
                elif metric=='loss_odm_srbbox':legend.append('{}'.format("loss_texture"))
                # legend.append('{}_{}'.format(json_log, metric))
                else:legend.append('{}'.format(metric))
