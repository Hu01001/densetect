...
def draw_feature_map(model, img_path, save_dir):
    ...
    for featuremap in featuremaps:
        ...
        # superimposed_img = heatmap * 0.3 + img*0.5  # 这里的0.4是热力图强度因子
        ...
        i=i+1
    # class_names=('plane', 'baseball-diamond', 'bridge', 'ground-track-field', 'small-vehicle', 'large-vehicle', 'ship', 'tennis-court', 'basketball-court', 'storage-tank', 'soccer-ball-field', 'roundabout', 'harbor', 'swimming-pool', 'helicopter')
    # show_result_pyplot(img, result,class_names, score_thr=0.05)
